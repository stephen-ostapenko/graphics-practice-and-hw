...
void main()
{
    ...
    out_color = vec4((lightness * albedo + env_albedo) / 2, 1.0);
}
)";
...
int main() try
{
    ...
    GLuint env_view_location = glGetUniformLocation(environment_program, "view");
    GLuint env_projection_location = glGetUniformLocation(environment_program, "projection");
    GLuint env_camera_position_location = glGetUniformLocation(environment_program, "camera_position");
    GLuint env_environment_texture_location = glGetUniformLocation(environment_program, "environment_texture");
    ...
    while (running)
    {
        ...
        glUniform1i(env_environment_texture_location, 0);
